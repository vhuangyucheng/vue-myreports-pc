...
function timerCallback1() {
  ...
  axios({
    ...
    if (response.data.code === '1') {
      console.log("output Timer 1 triggered at 3:14 PM yes");
    } else {
      console.log("output Timer 1 triggered at 3:14 PM fail");
    }
  })
}
...
function timerCallback2() {
  ...
  axios({
    ...
    if (response.data.code === '1') {
      console.log("output Timer 2 triggered at 23:29 PM yes");
    } else {
      console.log("output Timer 2 triggered at 23:29 PM failed");
    }
  })
}
...
function timerCallback3() {
  ...
  axios({
    ...
    if (response.data.code === '1') {
      console.log("output Timer 3 triggered at 6:44 AM yes");
    } else {
      console.log("output Timer 3 triggered at 6:44 AM failed");
    }
  })
}
