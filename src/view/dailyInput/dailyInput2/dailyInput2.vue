...
const firstELOnFinish = values => {
  ...
  axios({
    ...
    data: {
      shiftId: getShiftId(),
      firstel1Output: firstELFormState.firstEL1Output,
...
const laminationOnFinish = values => {
  ...
  axios({
    ...
    data: {
      ...
      laminator2Output: laminationFormState.laminator2Output,
      laminator3Output: laminationFormState.laminator3Output,
    },
    contentType: "json",
    processData: false,
    dataType: "json",
    ...
    <a-col :span="12">
            ...
            <div>
              ...
              >
                <a-form-item
                    ...
                    :rules="[{ required: true, message: '不能为空cannot empty' }]"
                >
                  <a-input v-model:value="materialFeedingFormState.glassOutput"/>
                </a-form-item>
                ...
                <a-form-item
                    label="EVA产量（玻璃面）EVAGlassOutput(glass side)"
                    name="evaglassOutput"
                    :rules="[{ required: true, message: '不能为空cannot empty' }]"
                >
                  <a-input v-model:value="materialFeedingFormState.evaglassOutput"/>
                </a-form-item>
                ...
                <a-form-item
                    label="背板产量backsheetOutput"
                    name="backsheetOutput"
                    :rules="[{ required: true, message: '不能为空cannot empty' }]"
                >
                  <a-input v-model:value="materialFeedingFormState.backsheetOutput"/>
                </a-form-item>
                ...
                <a-form-item
                    label="EVA产量（背板面）"
                    name="evabacksheetOutput"
                    :rules="[{ required: true, message: '不能为空cannot empty' }]"
                >
                  <a-input v-model:value="materialFeedingFormState.evabacksheetOutput"/>
                </a-form-item>
                ...
                <a-form-item
                    label="高温胶带产量highTemperatureTapeOutput"
                    name="highTemperatureTapeOutput"
                    :rules="[{ required: true, message: '不能为空cannot empty' }]"
                >
                  <a-input v-model:value="materialFeedingFormState.highTemperatureTapeOutput"/>
                </a-form-item>
          ...
          <div>
            ...
            >
              <a-form-item
                  ...
                  :rules="[{ required: true, message: '不能为空cannot empty' }]"
              >
                <a-input v-model:value="firstELFormState.firstEL1Output"/>
              </a-form-item>
        ...
        <a-col :span="24">
          ...
          <div>
            ...
            >
              ...
              <a-form-item
                  label="层压机laminator2"
                  name="laminator2Output"
                  :rules="[{ required: true, message: '不能为空cannot empty' }]"
              >
                <a-input v-model:value="laminationFormState.laminator2Output"/>
              </a-form-item>

              <a-form-item
                  label="层压机laminator3"
                  name="laminator3Output"
                  :rules="[{ required: true, message: '不能为空cannot empty' }]"
              >
                <a-input v-model:value="laminationFormState.laminator3Output"/>
              </a-form-item>
      ...
      <a-row>
        <a-col :span="24">
          ...
          <div>
            <a-form
                :model="trimmingFormState"
                name="trimmingFormState"
                :label-col="{ span: 10 }"
                :wrapper-col="{ span: 14 }"
                autocomplete="off"
                @finish="trimmingOnFinish"
                @finishFailed="onFinishFailed"
            >
              <a-form-item
                  label="削边产量TrimmingOutput"
                  name="trimmingOutput"
                  :rules="[{ required: true, message: '不能为空cannot empty' }]"
              >
                <a-input v-model:value="trimmingFormState.trimmingOutput"/>
              </a-form-item>
              <a-form-item :wrapper-col="{ offset: 8, span: 16 }">
                <a-button type="primary" html-type="submit" :disabled="isLock===1">提交Submit</a-button>
              </a-form-item>
        ...
        <a-col :span="24">
          ...
          <div>
            ...
            >
              ...
              <a-form-item
                  label="托盘报废PalletScrap:"
                  name="palletScrap"
                  :rules="[{ required: true, message: '不能为空cannot empty' }]"
              >
                <a-input v-model:value="secondHalfFormState.palletScrap"/>
              </a-form-item>

              <a-form-item
                  label="包装箱报废PackingCartonScrap:"
                  name="packingCartonScrap"
                  :rules="[{ required: true, message: '不能为空cannot empty' }]"
              >
                <a-input v-model:value="secondHalfFormState.packingCartonScrap"/>
              </a-form-item>

              <a-form-item
                  label="打包轧带报废PackingStrap:"
                  name="packingStrapScrap"
                  :rules="[{ required: true, message: '不能为空cannot empty' }]"
              >
                <a-input v-model:value="secondHalfFormState.packingStrapScrap"/>
              </a-form-item>
