  ...
  axios({
    ...
    axios({
      ...
      axios({
        ...
        let parseString = dataFromBack2['packingHourly' + getWeekdayNumber()]
...
let column;
onMounted(() => {
  column = new Column('ELDefectChat07', {
    data: dataToShow,
    xField: 'col_name',
    yField: 'amount',
    // isGroup: true,
...
<template>
  <div>
    <div id="chartTitle">Packing hourly output</div>
    <div id="ELDefectChat07" :style="{height:'450px'}"/>
  </div>
</template>
