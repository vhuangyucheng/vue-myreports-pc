  ...
  axios({
    ...
    axios({
      ...
      axios({
        ...
        let parseString = dataFromBack2['framingHourly' + getWeekdayNumber()]
...
let column;
onMounted(() => {
  column = new Column('ELDefectChat06', {
    data: dataToShow,
    xField: 'col_name',
    yField: 'amount',
    // isGroup: true,
...
<template>
  <div>
    <div id="chartTitle">Framing hourly output</div>
    <div id="ELDefectChat06" :style="{height:'450px'}"/>
  </div>
</template>
