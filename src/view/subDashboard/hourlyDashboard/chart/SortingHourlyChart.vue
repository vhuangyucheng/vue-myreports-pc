  ...
  axios({
    ...
    axios({
      ...
      axios({
        ...
        // console.log(dataFromBack2)
        let parseString = dataFromBack2['sortingHourly' + getWeekdayNumber()]
...
let column;
onMounted(() => {
  column = new Column('ELDefectChat08', {
    data: dataToShow,
    xField: 'col_name',
    yField: 'amount',
    // isGroup: true,
...
<template>
  <div>
    <div id="chartTitle">Sorting hourly output</div>
    <div id="ELDefectChat08" :style="{height:'450px'}"/>
  </div>
</template>
